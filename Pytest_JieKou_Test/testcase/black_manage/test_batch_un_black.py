...
class Test_userBlack:
    @pytest.mark.parametrize('args', read_testCase('black_manage\\batch_un_black.yaml'))
    @allure.story("取消拉黑用户至黑名单接口")
    def test_batch_unblackList(self, args,session_fixture):
