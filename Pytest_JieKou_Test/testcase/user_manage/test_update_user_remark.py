...
class Test_user_manage:
    @pytest.mark.parametrize('args', read_testCase('user_manage\\update_user_remark.yaml'))
    @allure.story("设置用户备注名接口")
    def test_update_user_remark(self, args,session_fixture):
